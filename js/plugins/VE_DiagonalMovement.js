...
(function() {
	...
	const parameters = PluginManager.parameters('VE_DiagonalMovement');
	...
	Game_CharacterBase.prototype.moveDiagonally = function(horz, vert) {
		if (this.isDiagonalEnabled() && !this.isDirectionFixed()) this.setDiagonalDirection(horz, vert);
		VictorEngine.DiagonalMovement.moveDiagonally.call(this, horz, vert);
		if (this.isDiagonalEnabled() && !this.isDirectionFixed()) this.diagonalDirection();
